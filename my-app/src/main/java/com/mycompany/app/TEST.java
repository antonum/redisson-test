...
public class TEST 
{
    ...
    {
    	System.out.println("Using master: "+System.getenv("REDIS_MASTER")); //"redis://35.196.252.193:12000"
    	System.out.println("Using slave: "+System.getenv("REDIS_SLAVE")); //"redis://34.73.135.35:13000"
		//org.apache.log4j.BasicConfigurator.configure();
		Config config = new Config();
		config.useMasterSlaveServers().setMasterAddress(System.getenv("REDIS_MASTER"))
		.setReadMode(ReadMode.SLAVE)
		.setPassword(System.getenv("REDIS_PASSWORD"))
		.addSlaveAddress(System.getenv("REDIS_SLAVE"));
